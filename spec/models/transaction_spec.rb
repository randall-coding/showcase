...
RSpec.describe Transaction, type: :model do
  tx_good = Transaction.new(txHash: "0x6f61ee4dc528443d8b6ab12240a53588fb72c659e1abfe6e6cc0d2346359be4a"   , data: \
  ...
  describe "doesn't save bad transactions," do
    before {tx_bad_dup = Transaction.create(txHash:tx_good.txHash,data:tx_good.data)}
